...
$(function(){   
    ...
    columns:[[    
		...
		{field:'cover',title:'封面',sortable:true,width:100},
        {field:'price',title:'价格',sortable:true,width:100},    
        {field:'isSold',title:'是否上架',sortable:true},
        {field:'sales',title:'销量',sortable:true,width:100},
        {field:'postage',title:'邮费',sortable:true},
        {field:'pv',title:'浏览量',sortable:true}
    ]],
