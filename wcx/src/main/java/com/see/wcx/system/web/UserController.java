...
import com.see.wcx.system.utils.UserUtil;
...
public class UserController extends BaseController {
	...
	public String update(@Valid @ModelAttribute @RequestBody User user,Model model) {
		...
		//设置流程用户组
		if(identityService.createUserQuery().userId(user.getId().toString()).singleResult()==null){
	...
	public String delete(@PathVariable("id") Integer id) {
		...
		//删除流程用户
		if(identityService.createUserQuery().userId(id.toString()).singleResult()==null){
	...
	public String updateUserRole(@PathVariable("id") Integer id,@RequestBody List<Integer> newRoleList) {
		...
		for (Integer roleId : newRoleList) {
			if(identityService.createGroupQuery().groupId(roleId.toString()).singleResult()!=null){
				identityService.deleteMembership(id.toString(), roleId.toString());
				identityService.createMembership(id.toString(), roleId.toString());
			}
		}
